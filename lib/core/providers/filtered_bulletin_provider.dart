...
final filteredBulletinPostsProvider = Provider<AsyncValue<List<BulletinPost>>>((
  ref,
) {
  ...
  return postsAsync.when(
    ...
    data:
        (posts) => hiddenAsync.when(
          loading: () => const AsyncValue.loading(),
          error: (error, stack) => AsyncValue.error(error, stack),
          data:
              (hiddenUserIds) => AsyncValue.data(
...
final bulletinFeedErrorProvider = Provider<Object?>((ref) {
  return ref.watch(bulletinFeedProvider).error;
});
